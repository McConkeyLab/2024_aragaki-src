...
#figure(
    ...
    caption: [*UC6 proliferation is uniquely inhibited by SRC knockdown.* *A:* MTT assay of UC6 and RT112 conditional SRC (004) or non-targeting (NT) knockdown cells (004, blue) exposed to varying concentrations of doxycycline (ng/mL) or bosutinib (nM). CI = 95%]
) <figs3>
...
= TODO
- Results
    - MTT: tt between NT and 004 at each dose
    - Western blots
