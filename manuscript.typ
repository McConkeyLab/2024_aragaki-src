...
#[
    ...
    Past work in preclinical models of solid tumors has implicated SRC in invasion and metastasis, but also demonstrated it inhibited bladder cancer metastasis. Here we tested the hypothesis that the role of SRC in metastasis is dependent on molecular subtype membership. Analyses of large public datasets demonstrated that SRC mRNA and protein expression is enriched in tumors assigned to the luminal papillary molecular subtype. Using the consensus classifier on RNA expression from 30 cell lines, we demonstrate that chemical SRC antagonists inhibit migration in luminal papillary cells but had little effect in basal/squamous lines. Conditional SRC knockdown inhibited migration in luminal papillary RT112 cells, whereas it increased migration and reduced proliferation in luminal papillary UM-UC6 cells. Regardless, these effects did not affect levels or sites of experimental metastasis _in vivo_. Overall, the results suggest that the potential use of clinical SRC pathway inhibitors to block bladder cancer progression in patients should be guided by molecular subtype.
]
...
#figure(
    grid(
        columns: 2,
        rows: (auto, auto),
        image("02_figures/lund-nmi-vs-mi.png"),
        image("02_figures/uromol-src-across-class.png"),
        grid.cell(
            colspan: 2,
...
To see if enrichment of EMT score translated to functional cell line motility per cell line, we performed migration assays using uncoated transwells, and invasion assays using Matrigel coated transwells, from cells within each class. We noted that LP lines tended to migrate (@fig4, A) and invade (@fig4, B) less readily than BS lines. However, this difference was not statistically significant, likely due to the variability of the assay.
...
We next determined if sensitivity to Src inhibition varied across consensus classes. We exposed a panel of both LP and BS lines to the Src inhibitor bosutinib. On average, LP lines migrated at 53% their original rate, while BS lines migrated 72% their average rate; However, neither of these changes were statistically significant (@fig5).
...
= DISCUSSION
Src was one of the first discovered proto-oncogenes @Martin_2004, and over 100 years of study have revealed it serves a complex and varied role in cancer@Thomas_1997. In this study, we sought to clarify some of the paradoxes that have arisen with Src in bladder cancer by looking through the lens of molecular subtypes. This study was made challenging for several reasons. Transwell assays continue to be a challenging, noisy, and low-throughput assays, plagued with confounding variables such as cell passage number, splitting time, and confluence at split. Further, since Src has been shown to be involved in both proliferation and motility@Thomas_1997, it is impossible to disentangle the results of transwells assays as that of pure motility or motility combined with changes to proliferation. This would additionally explain the discrepancies between our _in vitro_ migration assays and our _in vivo_ tail vein injection results. Proliferation, rather than motility, may be the key factor in determining survival. As our proliferation assays have shown, RT112 fails to have inhibition proliferated by SRC KD, while UM-UC6's proliferation is inhibited. This is reflected in the differences in survival. Conversely, Src may be important for migration in only RT112, as implied by our transwell assays.

In this study we have demonstrated that Src acts heterogeneously across different molecular subtypes. Molecular subtypes are clinically important and have been shown to be not only prognostic @Robertson_2017 @Lindskrog_2021, but also predictive for certain interventions @Choi_2014 @Powles_2021. By treating these subtypes as separate entities, we have shed light on the apparent paradox of Src acting as a tumor suppressor in some instances while acting as an oncogene in others. Src's preferential role for acting as a promoter of migration and invasion in luminal papillary lines may serve as a useful stratifier for designing future studies of Src inhibition _in vivo_.
