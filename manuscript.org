...
Differential SRC expression in human cell lines. We next examined whether SRC expression was also heterogeneous in a panel of 30 human bladder cancer cell lines. Unsupervised hierarchical clustering of whole transcriptome RNAseq data separated the lines into 3 major clusters that exhibited stepwise differences in SRC expression (Figure 3).

*** DONE
CLOSED: [2024-07-30 Tue 15:59]
